...
public class OnvifDevice {
    ...
    private static boolean logging = false; // enable/disable logging of SOAP messages
    ...
    public JaxWsProxyFactoryBean getServiceProxy(BindingProvider servicePort, String serviceAddr) {
        ...
        loggingFeature.setPrettyLogging(logging);
        loggingFeature.setVerbose(logging);
        if(!logging)  // If no logging, send the output nowhere
            loggingFeature.setSender(event -> {});
