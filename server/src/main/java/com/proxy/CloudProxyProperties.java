...
public final class CloudProxyProperties {
    ...
    private void setupConfigParams()
    {
        ...
        MQ_USER = config.getProperty("cloudProxy.mqUser");
        MQ_PASSWORD = config.getProperty("cloudProxy.mqPassword");
    ...
    public String getMQ_USER() {return MQ_USER;}
    public String getMQ_PASSWORD(){return MQ_PASSWORD;}
