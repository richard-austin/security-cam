...
import static com.securitycam.proxies.CloudAMQProxy.MessageMetadata.*;
...
public class CloudAMQProxy {
    ...
    public CloudAMQProxy(String webServerForCloudProxyHost, int webServerForCloudProxyPort, SimpMessagingTemplate brokerMessagingTemplate) throws JSONException {
    ...
    private void loginToCloud(Destination destination) throws JSONException {
        try {
